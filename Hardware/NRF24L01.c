...
//#define NRF24L01_CE_PIN       NRF24L01_MOSI_PIN
//#define NRF24L01_CSN_PORT     GPIOA
//#define NRF24L01_CSN_PIN      NRF24L01_MISO_PIN
...
/*发送部分*/
uint8_t NRF24L01_TxAddress[5] = {0x34,0x43,0x10,0x10,0x01};		//发送地址，固定5字节
#define NRF24L01_TX_PACKET_WIDTH		3							//发送数据包宽度，范围：1~32字节
uint8_t NRF24L01_TxPacket[NRF24L01_TX_PACKET_WIDTH];				//发送数据包

/*接收部分*/
uint8_t NRF24L01_RxAddress[5] = {0x34,0x43,0x10,0x10,0x01};;		//接收通道0地址，固定5字节
#define NRF24L01_RX_PACKET_WIDTH		3							//接收通道0数据包宽度，范围：1~32字节
...
void NRF24L01_W_CE(uint8_t BitValue)
{
	...
	GPIO_WriteBit(GPIOA, NRF24L01_CE_PIN, (BitAction)BitValue);
}
...
void NRF24L01_W_CSN(uint8_t BitValue)
{
	...
	GPIO_WriteBit(GPIOA, NRF24L01_CSN_PIN, (BitAction)BitValue);
}
...
void NRF24L01_W_SCK(uint8_t BitValue)
{
	...
	GPIO_WriteBit(GPIOA, NRF24L01_SCK_PIN, (BitAction)BitValue);
}
...
void NRF24L01_W_MOSI(uint8_t BitValue)
{
	...
	GPIO_WriteBit(GPIOA, NRF24L01_MOSI_PIN, (BitAction)BitValue);
}
...
{
	/*取MISO引脚的高低电平并返回*/
	return GPIO_ReadInputDataBit(GPIOA, NRF24L01_MISO_PIN);
}
...
void NRF24L01_GPIO_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = NRF24L01_CE_PIN | NRF24L01_CSN_PIN | NRF24L01_SCK_PIN | NRF24L01_MOSI_PIN;
